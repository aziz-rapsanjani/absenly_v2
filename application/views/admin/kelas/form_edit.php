...
<main class="main-content">
    ...
    <div class="p-5 flex-grow-1 d-flex justify-content-center">
        <div class="w-100" style="max-width: 600px;">
            <div class="mb-4">
                <h2 class="h4 fw-bold mb-1" style="color: var(--teks-utama);">Perbarui Informasi Kelas</h2>
                <p class="mb-0 text-muted" style="font-size: 0.9rem;">Ubah nama ruang kelas atau ganti penugasan Guru sebagai Wali Kelas.</p>
            </div>

            <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5">
                <form action="<?= base_url('adminkelas/update'); ?>" method="POST">
                    <input type="hidden" name="kelas_id" value="<?= $kelas['id']; ?>">
                    <div class="mb-4">
                        <label class="form-label fw-semibold" style="font-size: 0.85rem; color: var(--teks-sekunder);">NAMA KELAS</label>
                        <input type="text" name="nama_kelas" class="form-control form-control-lg border-light shadow-none bg-light" value="<?= htmlspecialchars($kelas['nama_kelas']); ?>" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-text" style="font-size: 0.75rem;">Ubah pilihan ini jika terjadi pergantian Wali Kelas untuk kelas bersangkutan.</div>
                    </div>
