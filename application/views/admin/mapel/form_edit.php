...
<main class="main-content">
    ...
    <div class="p-5 flex-grow-1 d-flex justify-content-center">
        <div class="w-100" style="max-width: 600px;">
            <div class="mb-4">
                <h2 class="h4 fw-bold mb-1" style="color: var(--teks-utama);">Edit Mata Pelajaran</h2>
                <p class="mb-0 text-muted" style="font-size: 0.9rem;">Perbarui nama mata pelajaran yang tersimpan dalam sistem.</p>
            </div>

            <div class="card border-0 shadow-sm rounded-4 p-4 p-md-5">
                <form action="<?= base_url('adminmapel/update'); ?>" method="POST">

                    <input type="hidden" name="mapel_id" value="<?= $mapel['id']; ?>">

                    <div class="mb-4">
                        <label class="form-label fw-semibold" style="font-size: 0.85rem; color: var(--teks-sekunder);">NAMA MATA PELAJARAN</label>
                        <input type="text" name="nama_mapel" class="form-control form-control-lg border-light shadow-none bg-light" value="<?= htmlspecialchars($mapel['nama_mapel']); ?>" required>
                    </div>
