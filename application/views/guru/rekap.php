...
<main class="main-content">
    ...
    <div class="p-5 flex-grow-1">
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4 p-4 bg-white">
            <form action="<?= base_url('gururekap'); ?>" method="GET" class="row g-3 align-items-end">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <?php if ($type_aktif == 'bulanan'): ?>
                        ...
                        <input type="month" name="bulan" class="form-control border-light bg-light" value="<?= $bulan_aktif; ?>" required>
                    <?php elseif ($type_aktif == 'mingguan'): ?>
                        <label class="form-label fw-bold text-muted small mb-1">Pilih Hari di Minggu Terkait</label>
                        <input type="date" name="tanggal" class="form-control border-light bg-light" value="<?= $tanggal_aktif; ?>" required>
                    <?php else: ?>
                ...
                <div class="col-md-3">
                    <button type="submit" class="btn btn-primary w-100 fw-medium shadow-sm" style="background-color: var(--primary-blue);">
